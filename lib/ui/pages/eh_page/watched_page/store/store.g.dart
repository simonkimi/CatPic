...
mixin _$EhWatchedStore on EhWatchedStoreBase, Store {
  final _$isLoadingAtom = Atom(name: 'EhWatchedStoreBase.isLoading');
  ...
  final _$lastExceptionAtom = Atom(name: 'EhWatchedStoreBase.lastException');
  ...
  final _$onDataChangeAsyncAction =
      AsyncAction('EhWatchedStoreBase.onDataChange');
